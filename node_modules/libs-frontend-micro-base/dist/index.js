import { OsDetect } from './osDetection.min.js';
import { autocomplete } from './autocomplete.min.js';
import { ThemeService } from './themeService.min.js';
import { appUtils } from './appUtils.min.js';

iePolyfill();

export { OsDetect , autocomplete, ThemeService, appUtils };

/*! ie11CustomProperties.min.js v3.0.6 | MIT License | https://git.io/fjXMN */
function iePolyfill() {
	'use strict';
	// check for support
