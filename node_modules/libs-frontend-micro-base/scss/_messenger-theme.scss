...
ul.messenger-theme-air .messenger-message {
  ...
  border: 0px;
  background-color: rgba( var(--cup-general-color-1-rgb), 0.8);
  position: relative;
  margin-bottom: 1em;
  font-size: 13px;
  color: #666666;
...
ul.messenger-theme-air .messenger-message .messenger-actions a {
  -moz-box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.05);
  -webkit-box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.05);
  box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.05);
...
ul.messenger-theme-air .messenger-message .messenger-actions a:hover {
  -moz-box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.15);
  -webkit-box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.15);
  box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), inset 0px 1px rgba( var(--cup-general-color-1-rgb), 0.15);
  color: #444444;
}
